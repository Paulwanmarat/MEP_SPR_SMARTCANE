...
This project is a Mini Engineering Project (MEP) for senior high school students. The purpose of this project is to create a smart walking cane using an ESP32 microcontroller. The smart cane is designed to help elderly or visually impaired people by improving safety while walking.
